...
{
    /**
     * Admin view – list all snapshots with their report & location
     */
    public function viewWeatherReports()
    {
        // Paginate snapshots, 10 per page
        $snapshots = Snapshot::with(['weatherReport.location'])->paginate(10);
    ...
    /**
     * User view – snapshots for a specific location or all
     */
    public function viewUserWeatherReports($locID = null)
    {
        ...
        $snapshots = Snapshot::with(['weatherReport.location'])->get();
     ...
     */
    // Add these methods to your WeatherReportsController class:
