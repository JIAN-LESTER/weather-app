    ...
    <form method="GET" action="{{ route('logs.show') }}" class="grid grid-cols-1 md:grid-cols-6 gap-4 items-end" role="search">
        ...
        <div class="md:col-span-2">
            ...
            <input type="text" name="search" id="search" value="{{ $search }}" placeholder="Search logs..."
                class="border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100">
        </div>
        ...
        <div>
            ...
            <select name="filter" id="filter" 
                class="border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-gray-500 focus:border-gray-500 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100">
        ...
        <div class="flex gap-2 md:col-span-1">
            <button type="submit" class="flex-1 bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors duration-200">Search</button>
            @if(request()->query())
